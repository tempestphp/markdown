...
class HeadingTokenTest extends TestCase
{
    ...
    public function test_parse_h1(): void
    {
        ...
        $this->assertEquals('<h1>Hello</h1>', $token->parse(new Parser()));
    }
    ...
    public function test_parse_h2(): void
    {
        ...
        $this->assertEquals('<h2>Hello</h2>', $token->parse(new Parser()));
    }

    #[Test]
    public function test_parse_h6(): void
    {
        $token = new HeadingToken('Hello', 6);

        $this->assertEquals('<h6>Hello</h6>', $token->parse(new Parser()));
    }
}
